        ...
        <AppBar position="static" style={{background: 'none', boxShadow: "none"}}>
            <Container maxWidth="xl">
                <Toolbar disableGutters>
                    ...
                    <Button variant="text" onClick={(e) => navigate('/requests')} style={pathname === '/requests' ? {fontWeight: 700, color: 'black' , width: 200, textDecoration: 'none'} : { color: 'black', width: 200, textDecoration: 'none'}}>{userRole === 'admin' ? 'Requests' : 'My Requests'}</Button>
